...
function WelcomeScreen(props) {
  ...
  ( 
      <div className="WelcomeScreen">
        ...
        <h4 className='welcome-text'> Log in to see upcoming events around the world for full-stack developers</h4>
        ...
        <a href="https://iamnachoj.github.io/meetApp/privacy.html" rel="nofollow noopener" > Privacy policy </a>
      </div>
  )
  : null
}
